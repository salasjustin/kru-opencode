...
description: Writing documents for agents. Use when creating or editing skills or agent definitions (agents/*.md), when modifying AGENTS.md or AGENTS.md, or when deciding whether a repo fact you just discovered earns a line in one.
---
